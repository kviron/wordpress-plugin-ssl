...
if (!function_exists('rsssl_send_php_security_headers')) {
	...
	function rsssl_send_php_security_headers()
    {
        if (rsssl_get_networkwide_option('rsssl_enable_php_headers') ) {
            ...
            $content_security_policy = rsssl_get_networkwide_option('rsssl_content_security_policy');
            ...
            if ($content_security_policy && !rsssl_get_networkwide_option('rsssl_add_csp_rules_to_htaccess') && !rsssl_get_networkwide_option('rsssl_enable_csp_reporting') ) {
	        ...
	        if ( rsssl_get_networkwide_option('rsssl_enable_csp_reporting' ) && !rsssl_get_networkwide_option('rsssl_add_csp_rules_to_htaccess') ) {
